...
export function ContentProject({
  ...
  return (
    <div className="project flex flex-col items-center justify-between h-[450px]  border-2 border-gray-500 rounded-2xl cursor-pointer p-8 shadow-lg transform transition duration-300 ease-in-out">
