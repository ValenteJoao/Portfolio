...
export function ContentProject({
  ...
  return (
    <div className="project flex flex-col items-center justify-between h-[450px]  border-2 border-gray-200 rounded-2xl cursor-pointer p-10 shadow-lg hover:scale-105 transform transition duration-300 ease-in-out">
